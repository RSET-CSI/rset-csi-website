...
export const teams: Team[] = [
  {
    name: "Core Team",
    members: [
      { src: "/images/c1.jpg", name: "President<br />Nikitha Sarah John" },
      { src: "/images/c2.jpg", name: "Vice President<br />David J Puthusserry" },
      { src: "/images/c3.jpg", name: "Secretary<br />Theresa Jose" },
      { src: "/images/c4.jpg", name: "Joint Secretary<br />Jala Vishwa Keerthi" },
      { src: "/images/c5.jpg", name: "Treasurer<br />Suraj Panickar" },
    ],
  },
  {
    name: "Technical Team",
    lead: {
      ...
      name: "George Emmanuel Thomas<br /> ( Lead )",
    },
    members: [
      { src: "/images/tech1.jpg", name: "Geevarghese Regi" },
      { src: "/images/tech2.png", name: "Abhishek Joby" },
      { src: "/images/tech3.jpg", name: "Soorya Das K S" },
      { src: "/images/tech4.jpg", name: "K J Theophene Xavier Lynn" },
    ],
  },
  {
    name: "Marketing Team",
    ...
    members: [
      { src: "/images/mark1.jpg", name: "Lanet Varghese" },
      { src: "/images/mark2.jpg", name: "Darin Tony" },
      { src: "/images/mark3.jpg", name: "Alina Mary John" },
    ],
  },
  {
    name: "Operations Team",
    lead: { src: "/images/oplead.jpg", name: "Janet Eldho<br /> ( Lead )" },
    members: [
      { src: "/images/op1.jpg", name: "Gayathri Binoj" },
      { src: "/images/op2.JPG", name: "Sneha Phinoo" },
      { src: "/images/op3.jpg", name: "Colin Pradeep" },
      { src: "/images/op4.jpg", name: "Aron Varghese John" },
    ],
  },
  {
    name: "Documentation Team",
    lead: { src: "/images/doclead.jpg", name: "Eby J Kavungal<br /> ( Lead )" },
    members: [
      { src: "/images/doc1.jpg", name: "Elin Maria Sabu" },
      { src: "/images/doc2.jpg", name: "Aafiya Shameer" },
      { src: "/images/doc3.jpg", name: "Fathima Naja" },
    ],
  },
  {
    name: "Creative Team",
    lead: { src: "/images/crlead.jpg", name: "Jose Chemmanoor<br /> ( Lead )" },
    members: [
      { src: "/images/cr1.jpg", name: "Vishnu M P" },
      { src: "/images/cr2.jpg", name: "Kripa Ann John" },
      { src: "/images/cr3.jpg", name: "Sreya Raj" },
      { src: "/images/cr4.jpg", name: "Cyriac James Boby" },
    ],
  },
  {
    name: "Coordinators",
